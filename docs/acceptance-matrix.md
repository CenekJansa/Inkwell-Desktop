...
| 7.1 Request intake | M1.1-M1.4, M2.3-M2.5 | M1: protocol, validation, native-host pipeline, Tauri harness, and Vue component tests; lifecycle evidence follows in M2 |
...
| 8.4 Cancellation response | M1.1, M2.4 | M1: exact schema, Vue cancellation, and framed in-process UI harness tests; lifecycle cases follow in M2.4 |
